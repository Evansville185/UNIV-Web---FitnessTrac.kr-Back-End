...
describe("/api/routine_activities", () => {
  describe("PATCH /api/routine_activities/:routineActivityId (**)", () => {
    it.only("Updates the count or duration on the routine activity", async () => {
    ...
    it.only("should return an error if the owner of the routine isn't the one trying to edit it", async () => {
